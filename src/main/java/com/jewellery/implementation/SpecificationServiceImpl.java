...
public class SpecificationServiceImpl implements SpecificationService {
    ...
    @Override
    public PaginatedResp<SpecificationRes> getSpecificationByProductId(int page, int size, String sortBy, String sortDirection, Long productId) {
        Sort sort = sortDirection.equalsIgnoreCase(Sort.Direction.ASC.name())
                ? Sort.by(sortBy).ascending()
                : Sort.by(sortBy).descending();
        Pageable pageable = PageRequest.of(page, size, sort);
        Page<SpecificationEntity> specificationPage = specificationRepo.findByProductId(productId, pageable);
